package mybanner.toerax.com.sendsms.view;
...
/**
 * Created by 19233 on 2018/7/17 15:00.
 */
public class CountDownProgressView extends TextView {
    ...
    public CountDownProgressView(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            //TODO 文字颜色属性
            if (typedArray.hasValue(R.styleable.CountDownProgress_text_Color)) {
                //有这个属性索引 获取用户设置的颜色
                textColor = typedArray.getColor(R.styleable.CountDownProgress_text_Color, 0);
            } else {
                //没有这个属性索引 默认是白色
                textColor = typedArray.getColor(R.styleable.CountDownProgress_text_Color, Color.parseColor("#ffffff"));
            }
