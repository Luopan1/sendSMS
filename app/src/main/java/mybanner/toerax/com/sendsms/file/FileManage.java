package mybanner.toerax.com.sendsms.file;
...
public class FileManage {
	...
	public class DirectoryPath {
		...
		/** 文件根目录 */
		public static final String FileRoot = "111111/吴优是罗攀的智障儿子/对的对的";
	...
	public static String getAssetsData(String name) {
		...
		try {
			InputStream is = APP.getInstance().getResources().getAssets().open(name);
