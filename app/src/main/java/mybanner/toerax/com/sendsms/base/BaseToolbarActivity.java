package mybanner.toerax.com.sendsms.base;
...
import mybanner.toerax.com.sendsms.R;
import mybanner.toerax.com.sendsms.db.DBManage;
import mybanner.toerax.com.sendsms.network.ApiService;
import mybanner.toerax.com.sendsms.network.HttpsRequest;
import mybanner.toerax.com.sendsms.uitls.ActivityUtil;
import mybanner.toerax.com.sendsms.uitls.ClickEventUtils;
import mybanner.toerax.com.sendsms.uitls.KeyBoardUtils;
import mybanner.toerax.com.sendsms.uitls.SizeUtils;
...
public abstract class BaseToolbarActivity extends AppCompatActivity {
    ...
    public void showLoadingDialog() {
        ...
        mLoadingDialog.setCancelable(false); // 是否可以按“返回键”消失
    ...
    protected void addToolBar() {
        ...
        mRightRelative = (RelativeLayout) view.findViewById(R.id.Relative);
        //        //初始化设置 Toolbar
    ...
    public void setRightTextImage(int imageRes) {
        //        Drawable drawable = getResources().getDrawable(imageRes);
        //        drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
        mRightText.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(imageRes), null, null, null);
    ...
    public void initToobar(int leftImage, String title, int rightImage) {
        ...
        mRightRelative.setOnClickListener(new View.OnClickListener() {
            @Override
